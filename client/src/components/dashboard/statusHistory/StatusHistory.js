...
class StatusHistory extends Component {
  ...
  render() {
    const columns = [
      ...
      { Header: 'COVID Patient Count', accessor: 'covidPatientCount' , width: 160},
      { Header: 'Total Patient Count', accessor: 'totalPatientCount' , width: 140},
      { Header: 'PPE Level', accessor: 'PPELevel' , width: 90},
      { Header: 'Accepting Covid Patients', accessor: 'acceptingCovidPatients' , width: 180},
      { Header: 'Accepting Non Covid Patients', accessor: 'acceptingNonCovidPatients' , width: 200},
      { Header: 'Tests Available', accessor: 'testsAvailableCount' , width: 120},
      { Header: 'Offers Full Medical Care', accessor: 'offersFullMedicalCare', width: 170},
    ]
    return (
      <Container>
        <div>
